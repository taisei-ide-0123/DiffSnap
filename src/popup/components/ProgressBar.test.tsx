...
describe('ProgressBar', () => {
  ...
  describe('Error handling', () => {
    ...
    it('shows error list when failed images exist', () => {
      const failedImages = [
        { url: 'https://example.com/image1.jpg', reason: 'Network timeout' },
      ]
      render(
        <ProgressBar
          status="error"
    ...
    it('displays multiple failed images', () => {
      const failedImages = [
        { url: 'https://example.com/image1.jpg', reason: 'Network timeout' },
        { url: 'https://example.com/image2.jpg', reason: '404 Not Found' },
        { url: 'https://example.com/image3.jpg', reason: 'CORS error' },
      ]
      render(
        <ProgressBar
          status="error"
    ...
    it('truncates long URLs', () => {
      ...
      const failedImages = [{ url: longUrl, reason: 'Error' }]
      render(
        <ProgressBar
          status="error"
          current={99}
    ...
    it('does not truncate short URLs', () => {
      ...
      const failedImages = [{ url: shortUrl, reason: 'Error' }]
      render(
        <ProgressBar
          status="error"
          current={99}
  ...
  describe('Retry functionality', () => {
    it('shows retry button when onRetry is provided', () => {
      const failedImages = [
        { url: 'https://example.com/image1.jpg', reason: 'Network error' },
      ]
      const onRetry = vi.fn()
      render(
        <ProgressBar
    ...
    it('shows retry button for each failed image', () => {
      const failedImages = [
        { url: 'https://example.com/image1.jpg', reason: 'Error 1' },
        { url: 'https://example.com/image2.jpg', reason: 'Error 2' },
      ]
      const onRetry = vi.fn()
      render(
        <ProgressBar
